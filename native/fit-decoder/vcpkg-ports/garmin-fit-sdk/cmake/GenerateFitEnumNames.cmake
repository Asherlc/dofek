function(generate_fit_enum_names input_file output_file)
  file(
    STRINGS "${input_file}"
    profile_definitions
    REGEX "^#define[ \t]+FIT_(SPORT|SUB_SPORT)_[A-Z0-9_]+"
  )
  ...
  if(sport_entries STREQUAL "" OR sub_sport_entries STREQUAL "")
    message(FATAL_ERROR "Unable to generate FIT sport names from ${input_file}")
  endif()
