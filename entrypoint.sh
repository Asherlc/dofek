...
DBT_ACTIVITY_MODELS="sensor_scalar_sample deduped_sensor activity_source_records activity_duplicate_matches activity_duplicate_groups deduped_activities deduped_activity_members activity_sensor_sample activity_location_sample activity_sensor_summary_rows activity_location_summary_rows activity_stream_points activity_heart_rate_zones activity_summary_rows hiking_activity body_measurement activity_vo2max_estimate activity_aerobic_efficiency activity_polarization_zones activity_power_curve cycling_activity daily_cycling provider_change_watermark provider_stats"
DBT_SLEEP_DASHBOARD_MODELS="heart_rate_day_freshness sleep_heart_rate_sample resting_heart_rate_sleep_window daily_sleep daily_recovery_inputs daily_recovery daily_endurance_load weekly_endurance_ramp_rate weekly_training_monotony daily_activity_load daily_strain daily_body_measurement healthspan_activity_zone_minutes weekly_healthspan"
