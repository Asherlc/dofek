...
describe("Apple Health streaming import (integration)", () => {
  ...
  it("enriches workouts with WorkoutStatistics HR data", async () => {
    const since = new Date("2024-01-01");
    const workouts: import("./workouts.ts").HealthWorkout[] = [];
  ...
  it("parses blood glucose into record batch", async () => {
    const since = new Date("2024-01-01");
    const bgRecords: import("./records.ts").HealthRecord[] = [];
  ...
  it("parses nutrition records", async () => {
    const since = new Date("2024-01-01");
    const nutritionRecords: import("./records.ts").HealthRecord[] = [];
  ...
  it("parses category records (mindful sessions)", async () => {
    const since = new Date("2024-01-01");
    const categories: import("./records.ts").CategoryRecord[] = [];
  ...
  it("routes walking distance and flights climbed", async () => {
    const since = new Date("2024-01-01");
    const distanceRecords: import("./records.ts").HealthRecord[] = [];
    const flightRecords: import("./records.ts").HealthRecord[] = [];
