import {
  ...
  buildMetricStreamDeleteScopeTableSql,
...
SELECT
  ...
  activity_bounds.provider_type AS provider_type,
  activity_bounds.modality AS modality,
  ...
  if(activity_bounds.modality IN ('indoor', 'virtual'),
     NULL,
