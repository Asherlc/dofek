...
export const metricStream = fitness.table(
  "metric_stream",
  {
    ...
    latitude: real("latitude"), // same-row point projection for bounded Postgres backfills
    longitude: real("longitude"), // same-row point projection for bounded Postgres backfills
