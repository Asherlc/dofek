...
export const DATASET_CONTRACTS = [
  ...
  },
  {
    ...
    analyticsModels: ["sleep_heart_rate_sample", "resting_heart_rate_sleep_window", "daily_sleep"],
  ...
  },
  {
    ...
    analyticsModels: ["daily_body_measurement"],
  ...
  },
  {
    ...
    analyticsModels: ["provider_stats"],
