/**
 * Training load computation functions.
 *
 * Pure functions for computing training stress metrics:
 * - TRIMP (Bannister Training Impulse)
 * - hrTSS (Heart Rate Training Stress Score)
 * - Power TSS
 * - TSS model (learned regression from paired HR+power data)
