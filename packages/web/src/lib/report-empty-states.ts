import type { MonthlyReportEmptyState, WeeklyReportEmptyState } from "dofek-server/types";

export const weeklyReportEmptyState: WeeklyReportEmptyState = {
  reportKind: "weekly",
...
export const monthlyReportEmptyState: MonthlyReportEmptyState = {
  reportKind: "monthly",
