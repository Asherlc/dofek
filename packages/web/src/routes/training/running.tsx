...
export function RunningTab() {
  ...
  const paceTrend = trpc.running.paceTrend.useQuery(selectedRangeQueryInput(days));
  const dynamics = trpc.running.dynamics.useQuery(selectedRangeQueryInput(days));
