    ...
    series: [
      {
        name: "Raw Weight",
        type: "scatter",
        data: data.map((d) => [d.date, d.rawWeight]),
        symbolSize: 4,
      ...
      },
      {
        name: "Trend",
        type: "line",
        data: data.map((d) => [d.date, d.smoothedWeight]),
        smooth: true,
        symbol: "none",
      ...
      },
      {
        ...
        type: "bar",
        yAxisIndex: 1,
        data: data.filter((d) => d.weeklyChange != null).map((d) => [d.date, d.weeklyChange]),
        itemStyle: {
