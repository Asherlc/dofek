...
import { NutritionDataQualityPanel } from "./NutritionDataQualityPanel.tsx";

describe("NutritionDataQualityPanel", () => {
  it("shows completeness and source overlap before interpretation", () => {
    render(
  ...
  it("reports a clean all-history window without inventing a denominator", () => {
    render(
      <NutritionDataQualityPanel
        dataQuality={{
