...
- **Error Handling**: Use `TRPCError` with semantic codes. Never swallow errors; ensure they are logged and reported to Sentry if they represent internal failures.
- **Testing**:
