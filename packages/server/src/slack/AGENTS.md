...
- Food database boundary rule: do not introduce Slack-specific columns or semantics into `fitness.food_entry` or row-based nutrient tables such as `fitness.food_entry_nutrient`; these remain provider-agnostic food data tables.
