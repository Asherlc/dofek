  ...
  beforeAll(async () => {
    ...
    await postgres.db.execute(sql`
      INSERT INTO fitness.activity (
        ...
        (${firstSourceId}::uuid, ${pelotonProvider}, ${userId}::uuid, 'peloton-first',
        ...
        (${mirrorSourceId}::uuid, ${mirrorProvider}, ${userId}::uuid, 'mirror-first',
          'cycling', 'cycling', 'indoor', '2026-06-01T17:00:00Z', '2026-06-01T17:30:00Z',
          '30 min Power Zone mirror', '{}'::jsonb,
          'America/Los_Angeles', -420, -420, 'device_timezone'),
        (${secondSourceId}::uuid, ${pelotonProvider}, ${userId}::uuid, 'peloton-second',
