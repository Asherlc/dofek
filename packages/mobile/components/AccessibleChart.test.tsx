...
describe("AccessibleChart", () => {
  it("exposes a concise VoiceOver summary and hides visual-only chart children", () => {
    render(
      <AccessibleChart
        title="Heart rate"
      ...
      >
        <Text>visual-only axis label</Text>
      </AccessibleChart>,
    );
    ...
    expect(
      screen
        .getByText("visual-only axis label")
        .parentElement?.getAttribute("importantforaccessibility"),
