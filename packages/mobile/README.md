...
- **Bluetooth Heart-Rate Monitors**: Live heart rate + R-R intervals from any standard Bluetooth heart-rate strap (Heart Rate Service `0x180D`) via `BleHeartRateModule`. See `../../docs/ble-heart-rate.md`.
