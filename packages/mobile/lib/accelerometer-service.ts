...
export interface WhoopBleDeps {
  ...
  getBufferedSamples(): Promise<Array<{ timestamp: string; x: number; y: number; z: number }>>;
}
 ...
 */
export function createAccelerometerService(deps: AccelerometerServiceDeps): AccelerometerService {
