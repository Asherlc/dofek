...
3. **Deploy App** (`deploy-app.yml`):
   1. Install Infisical CLI, export deploy-tagged secrets to `$RUNNER_TEMP/.env.prod`, validate required deploy keys, and fetch `APPLE_PRIVATE_KEY` separately to a temporary file.
