...
- daily HRV and step samples for 18–31 August in the canonical,
  provider-attributed relational daily-metrics path;
...
the supplied HRV and steps metrics from the canonical daily-metrics source. It
does not calculate health values in the client.
