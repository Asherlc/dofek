...
- Create: `drizzle/0101_app_store_billing.sql`
...
```bash
git add src/db/schema/account.ts drizzle/0101_app_store_billing.sql packages/server/src/billing/entitlement.ts packages/server/src/billing/entitlement.test.ts
