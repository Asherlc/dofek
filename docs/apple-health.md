...
Dofek no longer writes food entries back to Apple Health during provider synchronization. The mobile account-erasure cleanup retains the ability to remove legacy Dofek-written dietary samples by their HealthKit sync identifiers.
