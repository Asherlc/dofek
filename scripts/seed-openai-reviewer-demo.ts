...
const dailyMetrics = [
  ["2026-08-18", 58, 7420], ["2026-08-19", 61, 8150], ["2026-08-20", 59, 6900],
  ["2026-08-21", 63, 10120], ["2026-08-22", 65, 11340], ["2026-08-23", 62, 8840],
  ["2026-08-24", 60, 7750], ["2026-08-25", 64, 9520], ["2026-08-26", 66, 10680],
  ["2026-08-27", 63, 9180], ["2026-08-28", 67, 11240], ["2026-08-29", 65, 9880],
  ["2026-08-30", 68, 12060], ["2026-08-31", 66, 10940],
] as const;

const sleepDates = ["2026-08-25", "2026-08-26", "2026-08-27", "2026-08-28", "2026-08-29", "2026-08-30", "2026-08-31"] as const;
const activities = [
...
async function main(): Promise<void> {
  ...
  try {
    ...
    console.log("Seeded synthetic OpenAI reviewer demo: 14 daily metrics, 7 sleep records, 4 activities, 3 provider syncs");
  } finally {
    await sql.end();
  }
}
