-- Recreate activity_summary materialized view.
--
-- Migration 0041_cross_type_activity_dedup.sql dropped v_activity with CASCADE,
-- which cascaded into activity_summary. Since 0041_dedup_activity_summary.sql had
-- already been applied, it was not re-run, leaving activity_summary missing.
-- This caused "column asum.avg_hr does not exist" errors on every dashboard load.
