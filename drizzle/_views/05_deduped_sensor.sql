...
legacy_fallback AS (
  ...
  CROSS JOIN LATERAL (
    VALUES
      ...
      ('grade', ms.grade),
      ('vertical_speed', ms.vertical_speed),
      ('spo2', ms.spo2),
      ('respiratory_rate', ms.respiratory_rate),
      ('gps_accuracy', ms.gps_accuracy::REAL),
      ('accumulated_power', ms.accumulated_power::REAL),
      ('stress', ms.stress::REAL),
      ('left_right_balance', ms.left_right_balance),
      ('vertical_oscillation', ms.vertical_oscillation),
      ('stance_time', ms.stance_time),
      ('stance_time_percent', ms.stance_time_percent),
      ('step_length', ms.step_length),
      ('vertical_ratio', ms.vertical_ratio),
      ('stance_time_balance', ms.stance_time_balance),
      ('ground_contact_time', ms.ground_contact_time),
      ('stride_length', ms.stride_length),
      ('form_power', ms.form_power),
      ('leg_spring_stiff', ms.leg_spring_stiff),
      ('air_power', ms.air_power),
      ...
      ('combined_pedal_smoothness', ms.combined_pedal_smoothness)
