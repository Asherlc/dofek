-- Canonical definition of the fitness.deduped_sensor view.
-- This view handles best-source deduplication and legacy metric_stream fallback.
-- It is recreated as a plain view to avoid refresh costs and concurrent locks.
...
-- Final combined view.
SELECT * FROM linked_samples
UNION ALL
SELECT * FROM ambient_samples;
