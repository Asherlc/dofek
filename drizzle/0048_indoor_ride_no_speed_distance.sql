-- Null out speed and distance for indoor rides in the activity_summary view.
-- Indoor rides (indoor_cycling, virtual_cycling) report simulated speed/distance
-- from the trainer or virtual platform, which is not physically meaningful.
